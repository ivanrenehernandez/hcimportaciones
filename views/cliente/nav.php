<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="<?= base_url ?>cliente/index">IHCImportaciones</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url ?>cliente/perfil">Perfil</a>
            </li>
            <!-- <li class="nav-item">
        ...
        <a href="<?= base_url ?>cliente/logout" class="btn btn-info py-2 rounded float-right">Cerrar Sesión</a>
    </div>
</nav>