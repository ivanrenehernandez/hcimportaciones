                ...
                <div class="col-12 col-sm-12 col-md-6 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url ?>administrador/actualizarVendedor" method="POST">
                                <input type="hidden" name="id" value="<?= $vendedor->id ?>">
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <div class="form-group mb-2">
                                            <label class="font-weight-bold">Nombres</label>
                                            <input type="text" name="nombres" class="form-control" aria-describedby="helpId" value="<?= $vendedor->nombres ?>" required>
                                            <small id="helpId" class="text-muted"></small>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="font-weight-bold">Apellidos</label>
                                            <input type="text" name="apellidos" class="form-control" aria-describedby="helpId" value="<?= $vendedor->apellidos ?>" required>
                                            <small id="helpId" class="text-muted"></small>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="font-weight-bold">Documento</label>
                                            <input type="text" name="documento" class="form-control" aria-describedby="helpId" value="<?= $vendedor->documento ?>" required>
                                            <small id="helpId" class="text-muted"></small>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="font-weight-bold">Celular</label>
                                            <input type="text" name="celular" class="form-control" aria-describedby="helpId" value="<?= $vendedor->celular ?>" required>
                                            <small id="helpId" class="text-muted"></small>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="font-weight-bold">Email</label>
                                            <input type="email" name="email" class="form-control" aria-describedby="helpId" value="<?= $vendedor->email ?>" required>
                                            <small id="helpId" class="text-muted"></small>
                                        </div>
                                        <div class="form-group my-2">
                                            <label class="font-weight-bold">Fecha de Nacimiento</label>
                                            <input type="date" name="fecha_nacimiento" class="form-control" aria-describedby="helpId" value="<?= $vendedor->fecha_nacimiento ?>" min="1900-01-31" max="2005-01-31" required>
                                            <small id="helpId" class="text-muted"></small>
                                        </div>
